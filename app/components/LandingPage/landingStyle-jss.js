...
const styles = theme => ({
  ...
  contactBubble: {
    ...
    [theme.breakpoints.up('lg')]: {
      ...
      backgroundImage: theme.palette.type === 'dark' ? 'url(https://firebasestorage.googleapis.com/v0/b/cashme-web-app.appspot.com/o/bubbleDark.png?alt=media&token=d13c0324-d32f-4a5b-9bf0-036da19fcd4a)' : 'url(/images/decoration/bubbleLight.png)',
      backgroundColor: 'transparent',
      boxShadow: 'none',
