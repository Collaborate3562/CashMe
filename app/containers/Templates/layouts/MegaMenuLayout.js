    ...
    <Fragment>
      ...
      >
        ...
        <section className={classNames(classes.mainWrap, classes.topbarLayout)}>
          ...
          {!pageLoaded && (<img src="https://firebasestorage.googleapis.com/v0/b/cashme-web-app.appspot.com/o/spinner.gif?alt=media&token=b38cc2d2-3780-40f5-ad5a-87fe0d896a38" alt="spinner" className={classes.circularProgress} />) }
          <Fade
            in={pageLoaded}
